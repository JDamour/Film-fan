...
import com.mpatswe.fan.film.filmfan.R;
import com.mpatswe.fan.film.filmfan.api.model.Genre;
import com.mpatswe.fan.film.filmfan.api.model.Images;
import com.mpatswe.fan.film.filmfan.api.model.Movie;
import com.mpatswe.fan.film.filmfan.api.model.SpokenLanguage;
import com.mpatswe.fan.film.filmfan.app.App;
...
public class DetailActivity extends AppCompatActivity implements DetailContract.View {
    ...
    public void showContent(Movie movie) {
        ...
        languageTextView.setText(getPopularity(movie));
    ...
    private String getPopularity(Movie movie) {
        java.text.DecimalFormat decimalFormat = new java.text.DecimalFormat("#.#");
        return decimalFormat.format( movie.popularity);
    }
